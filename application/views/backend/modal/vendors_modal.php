...
<!-- MODAL -->
        <!-- Add Records Modal -->
        <div class="modal fade text-left" id="modal_form_vendor" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body formvendor">
                    
                    <?php
                        $attributes = array('class' => 'form-horizontal', 'id' => 'formvendor');
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    <label for="valid-state">Nama Vendor</label>
                                    <input type="text" name="nama" class="form-control nama" id="nama" placeholder="Nama Vendor">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success ml-1 btnSave" id="btnSave" onclick="addvendor()">
...
<!-- Import Modal -->
                                <form id="add-row-form" action="<?php echo site_url('backend/Master_vendor/import');?>" method="post" enctype="multipart/form-data">
